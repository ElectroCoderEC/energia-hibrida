...
'''
    ...
    with open("predict_renewable_system.py", "w") as f:
...
if __name__ == "__main__":
    ...
    fig_costs1.savefig(
        "explicacion_costos_renovables1.png", dpi=300, bbox_inches="tight"
    )
    fig_costs2.savefig(
        "explicacion_costos_renovables2.png", dpi=300, bbox_inches="tight"
    )
