...
def generate_renewable_system_data():
    ...
    for school_name, params in school_params.items():
        ...
        # Degradación anual
        solar_degradation = 0.0005 * system_age  # 0.5% degradación anual
        battery_degradation = 0.002 * system_age  # 2% degradación anual
...
def plot_sample_data():
    ...
    school_data = school_data.head(365)
    ...
    plt.title(f"Generación vs Consumo: {school_sample} (Anual)")
    plt.xlabel("Fecha")
    ...
    plt.title(f"Composición de Generación Renovable: {school_sample} (Anual)")
    plt.xlabel("Fecha")
    ...
    plt.title(f"Porcentaje de Autosuficiencia: {school_sample} (Anual)")
    plt.xlabel("Fecha")
